...
```
$ git clone https://github.com/cspace-deployment/cspace-ui-plugin-profile-ucbg.js.git
...
```
$ npm run devserver --back-end=https://ucbg.qa.collectionspace.org
```
...
environment variable `CSPACE_UCBG_UI_BASE_URL_OPT` set to `http://localhost:8080/` (note the
